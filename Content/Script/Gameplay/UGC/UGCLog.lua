...
Log.Codes = {
    ...
    smoke_run_begin           = "冒烟验收开始",
    smoke_item_result         = "冒烟验收单项结果",
    smoke_item_note           = "冒烟验收单项过程说明",
    smoke_run_summary         = "冒烟验收总结",
    smoke_run_skipped         = "冒烟验收跳过（已有一轮在跑）",
    smoke_probe               = "冒烟验收环境自检",
    smoke_unavailable         = "冒烟验收模块不可用",
    prefab_definitions_unavailable = "预制体 Definition 列表不可用（退回 Catalog 兜底）",
    prefab_definition_missing = "资产缺少 UUGCPrefabDefinition",
    prefab_definition_register_failed = "运行时预制体 Definition 注册失败",
    unknown_property          = "未知属性键（见 UGCPropertySchema）",
    invalid_property_value    = "属性值不符合 schema",
    property_limit_reached    = "实体属性数量达到上限",
    reference_not_found       = "属性引用目标不存在",
    missing_property          = "属性未设置",
    entity_not_found          = "实体不存在",
    view_refresh_failed       = "界面刷新回调异常",
    invalid_parent            = "层级父级不合法",
    hierarchy_cycle           = "层级操作会形成环",
